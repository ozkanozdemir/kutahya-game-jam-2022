...
public class YawnButton : MonoBehaviour
{
    ...
    public void OnMouseUpAsButton()
    {
        ...
        anim4.SetInteger("Animate", 1);
        anim5.SetInteger("Animate", 1);
        anim6.SetInteger("Animate", 1);
        anim7.SetInteger("Animate", 1);
        anim8.SetInteger("Animate", 1);
        anim9.SetInteger("Animate", 1);
        anim10.SetInteger("Animate", 1);
        anim11.SetInteger("Animate", 1);
        anim12.SetInteger("Animate", 1);
        anim13.SetInteger("Animate", 1);
        anim14.SetInteger("Animate", 1);
        anim15.SetInteger("Animate", 1);
        anim16.SetInteger("Animate", 1);
        anim17.SetInteger("Animate", 1);
        anim18.SetInteger("Animate", 1);
        anim19.SetInteger("Animate", 1);
        anim20.SetInteger("Animate", 1);
        anim21.SetInteger("Animate", 1);
        anim22.SetInteger("Animate", 1);
        anim23.SetInteger("Animate", 1);
        anim24.SetInteger("Animate", 1);
        anim25.SetInteger("Animate", 1);
        anim26.SetInteger("Animate", 1);
        anim27.SetInteger("Animate", 1);
        anim28.SetInteger("Animate", 1);
        anim29.SetInteger("Animate", 1);
        anim30.SetInteger("Animate", 1);
        anim31.SetInteger("Animate", 1);
        anim32.SetInteger("Animate", 1);
        anim33.SetInteger("Animate", 1);
        anim34.SetInteger("Animate", 1);
        anim35.SetInteger("Animate", 1);
        anim36.SetInteger("Animate", 1);
    }
}
