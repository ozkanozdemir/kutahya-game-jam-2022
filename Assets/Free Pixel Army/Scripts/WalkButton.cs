...
public class WalkButton : MonoBehaviour
{
    ...
    public void OnMouseUpAsButton()
    {
        ...
        anim4.SetInteger("Animate", 2);
        anim5.SetInteger("Animate", 2);
        anim6.SetInteger("Animate", 2);
        anim7.SetInteger("Animate", 2);
        anim8.SetInteger("Animate", 2);
        anim9.SetInteger("Animate", 2);
        anim10.SetInteger("Animate", 2);
        anim11.SetInteger("Animate", 2);
        anim12.SetInteger("Animate", 2);
        anim13.SetInteger("Animate", 2);
        anim14.SetInteger("Animate", 2);
        anim15.SetInteger("Animate", 2);
        anim16.SetInteger("Animate", 2);
        anim17.SetInteger("Animate", 2);
        anim18.SetInteger("Animate", 2);
        anim19.SetInteger("Animate", 2);
        anim20.SetInteger("Animate", 2);
        anim21.SetInteger("Animate", 2);
        anim22.SetInteger("Animate", 2);
        anim23.SetInteger("Animate", 2);
        anim24.SetInteger("Animate", 2);
        anim25.SetInteger("Animate", 2);
        anim26.SetInteger("Animate", 2);
        anim27.SetInteger("Animate", 2);
        anim28.SetInteger("Animate", 2);
        anim29.SetInteger("Animate", 2);
        anim30.SetInteger("Animate", 2);
        anim31.SetInteger("Animate", 2);
        anim32.SetInteger("Animate", 2);
        anim33.SetInteger("Animate", 2);
        anim34.SetInteger("Animate", 2);
        anim35.SetInteger("Animate", 2);
        anim36.SetInteger("Animate", 2);
    }
}
